...
#define BAT_DELAY 30000       //set to 100ms, which corresponds to a reading 10Hz frequency.
#define SD_DELAY 10
#define LORA_DELAY 30000
...
//Wifi Parameters
const char* wifiSSID = "obsatserver";                  //Wifi's "name"
const char* wifiPassword = "obsatpass";         //Wifi's password
...
const char* serverName = "http://192.168.4.1/";*/  // Server url = "http://ip:port/"
